...
lora_model_dir = "./motionQA_delta_finetuned_lora_mps" ## Finetuning 한 모델을 써야함
...
pose_json_path = "./Custom_Data/raise_arm2.json"
...
abs_positions = {
    j: accumulate(baseline[j], seq) for j, seq in pred_deltas.items()
}
